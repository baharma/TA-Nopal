            ...
            <div class="col">
                <div class="card p-3">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold">90%</h5>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card p-3" style="">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold">70c</h5>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card p-3" style="">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold">100 Lx</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-between container mt-5">
        ...
        <div class="card" style="width: 500px;">
            ...
            <ul class="list-group list-group-flush text-center">
                ...
                <li class="list-group-item">Tutup</li>
            </ul>
        </div>
    </div>
                ...
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" width="100" height="50" type="checkbox" id="flexSwitchCheckChecked" >
